...
# Check subset
if (! data_subset %in% c("strict", "std.1", "std.2", "relaxed", "priority_genes_relaxed", "priority_genes_strict")){
...
source(paste(scripts_folder,"s08_SKAT_accessory_functions.R", sep="/"))
